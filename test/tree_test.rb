...
class TreeTest < Minitest::Test
  ...
  # end
  #
  # def test_tree_can_output_middle_node_as_json
  #   tree = Tree.new
  #   tree.insert('cat')
  #   parent = tree.root_node.find_child('c')
  #   node = tree.root_node.find_child('c').find_child('a')
  #   json_version = [
  #     {
  #       "name": "a",
  #       "parent": "c",
  ...
  #     }
  #   ];
  #   assert_equal json_version, tree.branch_as_json(node)
  # end
  #
  def test_tree_can_output_middle_node_as_json
    tree = Tree.new
  ...
  #
  # def test_tree_can_output_middle_node_as_json_when_4_letters_present
  #   tree = Tree.new
  #   tree.insert('cat')
  #   tree.insert('cab')
  #   parent = tree.root_node.find_child('c')
  ...
  # end
  #
  # def test_tree_can_output_middle_node_as_json_when_the_branch_splits
  #   tree = Tree.new
  #   tree.insert('cats')
  #   tree.insert('cattle')
  #   parent = tree.root_node.find_child('c')
  ...
  #   tree = Tree.new
  #   tree.insert('cat')
  #   node = tree.root_node.find_child('c')
  #   json_version = [
  #     {
  #       "name": "",
  #       "parent": "null",
