...
class TreeTest < Minitest::Test
  ...
  def test_tree_count_will_return_two_when_populated_with_two_words_short_first
  ...
  def test_tree_count_will_return_two_when_populated_with_two_words_long_first
    test_two_tree = Tree.new
    test_two_tree.insert('cats')
    test_two_tree.insert('cat')
    assert_equal 2, test_two_tree.count
